...
- `FRONTEND=web` → work in `apps/web/` (Next.js), read `RULES-NEXT.md`
- `FRONTEND=tanstack` → work in `apps/tanstack/` (TanStack Start), read `RULES-TANSTACK.md`

**Only modify the active frontend. Read the corresponding `RULES-*.md` file for framework-specific conventions.**
